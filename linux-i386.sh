...
cmake -DCMAKE_INSTALL_PREFIX=../libuv-v1.32.0-linux-i386 -DCMAKE_BUILD_TYPE=Release ../libuv-v1.32.0.src
make -j2
make install
cd ..
tar czf libuv-v1.32.0-linux-i386.tar.gz libuv-v1.32.0-linux-i386
